...
neko_enum_decl(neko_render_buffer_flags, R_BUFFER_FLAG_MAP_PERSISTENT, R_BUFFER_FLAG_MAP_COHERENT);
...
typedef struct neko_render_storage_buffer_desc_t {
    ...
    neko_render_buffer_flags flags;
    neko_render_buffer_update_desc_t update;
...
typedef struct neko_render_t {
    ...
    struct {
        ...
        // Util
        void* (*storage_buffer_map_get)(neko_handle(neko_render_storage_buffer_t) hndl);
        void* (*storage_buffer_lock)(neko_handle(neko_render_storage_buffer_t) hndl);
        void (*storage_buffer_unlock)(neko_handle(neko_render_storage_buffer_t) hndl);
...
NEKO_API_DECL void* neko_render_storage_buffer_map_get(neko_handle(neko_render_storage_buffer_t) hndl);
NEKO_API_DECL void* neko_render_storage_buffer_lock(neko_handle(neko_render_storage_buffer_t) hndl);
NEKO_API_DECL void neko_render_storage_buffer_unlock(neko_handle(neko_render_storage_buffer_t) hndl);
...
NEKO_API_DECL bool neko_asset_texture_load_from_memory(const void* memory, size_t sz, void* out, neko_render_texture_desc_t* desc, bool flip_on_load, bool keep_data);
...
NEKO_API_DECL void neko_batch_reset_function_ptrs(neko_batch_t* sb, submit_batch_fn* batch_callback, get_pixels_fn* get_pixels_callback, generate_texture_handle_fn* generate_texture_callback,
