...
void neko_idraw_v3fv(idraw_t* neko_idraw, neko_vec3 v);
...
void neko_idraw_renderpass_submit(idraw_t* neko_idraw, neko_command_buffer_t* cb, neko_vec4 viewport, Color256 clear_color);
...
void neko_idraw_rotatev(idraw_t* neko_idraw, f32 angle, neko_vec3 v);
...
void neko_idraw_linev(idraw_t* neko_idraw, neko_vec2 v0, neko_vec2 v1, Color256 c);
void neko_idraw_line3D(idraw_t* neko_idraw, f32 x0, f32 y0, f32 z0, f32 x1, f32 y1, f32 z1, u8 r, u8 g, u8 b, u8 a);
void neko_idraw_line3Dv(idraw_t* neko_idraw, neko_vec3 s, neko_vec3 e, Color256 color);
...
void neko_idraw_rect3Dv(idraw_t* neko_idraw, neko_vec3 min, neko_vec3 max, neko_vec2 uv0, neko_vec2 uv1, Color256 color, gfx_primitive_type type);
