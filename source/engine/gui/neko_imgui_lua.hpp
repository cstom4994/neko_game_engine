...
#ifndef NEKO_IMGUI_LUA_HPP
#define NEKO_IMGUI_LUA_HPP
    ...
    lua_pushcclosure(
            ...
            [](lua_State* L) {
                if (lua_isstring(L, 1)) {
                    ...
                    if (neko_str_equals(element, "Window")) {
                        lua_bind::window(L);
                    } else if (neko_str_equals(element, "Button")) {
                        lua_bind::button(L);
                    } else if (neko_str_equals(element, "Label")) {
                        lua_bind::label(L);
                    } else if (neko_str_equals(element, "Checkbox")) {
                        lua_bind::check_box(L);
                    } else if (neko_str_equals(element, "Slider")) {
                        lua_bind::slider(L);
                    } else if (neko_str_equals(element, "ColorPicker")) {
                        lua_bind::color_picker(L);
                    } else if (neko_str_equals(element, "ListBox")) {
                        lua_bind::list_box(L);
                    } else if (neko_str_equals(element, "TabSelector")) {
