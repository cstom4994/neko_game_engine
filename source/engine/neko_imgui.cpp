...
static util::TableInteger ChildFlags[] = {
        ENUM(ImGuiChildFlags, None),        ENUM(ImGuiChildFlags, Border),      ENUM(ImGuiChildFlags, AlwaysUseWindowPadding), ENUM(ImGuiChildFlags, ResizeX),    ENUM(ImGuiChildFlags, ResizeY),
        ENUM(ImGuiChildFlags, AutoResizeX), ENUM(ImGuiChildFlags, AutoResizeY), ENUM(ImGuiChildFlags, AlwaysAutoResize),       ENUM(ImGuiChildFlags, FrameStyle),
};
...
static util::TableInteger SelectableFlags[] = {
        ENUM(ImGuiSelectableFlags, None),     ENUM(ImGuiSelectableFlags, DontClosePopups), ENUM(ImGuiSelectableFlags, SpanAllColumns), ENUM(ImGuiSelectableFlags, AllowDoubleClick),
        ENUM(ImGuiSelectableFlags, Disabled), ENUM(ImGuiSelectableFlags, AllowOverlap),
};

static util::TableInteger ComboFlags[] = {
        ENUM(ImGuiComboFlags, None),          ENUM(ImGuiComboFlags, PopupAlignLeft), ENUM(ImGuiComboFlags, HeightSmall), ENUM(ImGuiComboFlags, HeightRegular),   ENUM(ImGuiComboFlags, HeightLarge),
        ENUM(ImGuiComboFlags, HeightLargest), ENUM(ImGuiComboFlags, NoArrowButton),  ENUM(ImGuiComboFlags, NoPreview),   ENUM(ImGuiComboFlags, WidthFitPreview),
};
...
static util::TableInteger TabItemFlags[] = {
        ENUM(ImGuiTabItemFlags, None),     ENUM(ImGuiTabItemFlags, UnsavedDocument),  ENUM(ImGuiTabItemFlags, SetSelected), ENUM(ImGuiTabItemFlags, NoCloseWithMiddleMouseButton),
        ENUM(ImGuiTabItemFlags, NoPushId), ENUM(ImGuiTabItemFlags, NoTooltip),        ENUM(ImGuiTabItemFlags, NoReorder),   ENUM(ImGuiTabItemFlags, Leading),
        ENUM(ImGuiTabItemFlags, Trailing), ENUM(ImGuiTabItemFlags, NoAssumedClosure),
};
...
static util::TableInteger DockNodeFlags[] = {
        ENUM(ImGuiDockNodeFlags, None),           ENUM(ImGuiDockNodeFlags, KeepAliveOnly), ENUM(ImGuiDockNodeFlags, NoDockingOverCentralNode), ENUM(ImGuiDockNodeFlags, PassthruCentralNode),
        ENUM(ImGuiDockNodeFlags, NoDockingSplit), ENUM(ImGuiDockNodeFlags, NoResize),      ENUM(ImGuiDockNodeFlags, AutoHideTabBar),           ENUM(ImGuiDockNodeFlags, NoUndocking),
};
...
static util::TableInteger ColorEditFlags[] = {
        ENUM(ImGuiColorEditFlags, None),           ENUM(ImGuiColorEditFlags, NoAlpha),          ENUM(ImGuiColorEditFlags, NoPicker),  ENUM(ImGuiColorEditFlags, NoOptions),
        ENUM(ImGuiColorEditFlags, NoSmallPreview), ENUM(ImGuiColorEditFlags, NoInputs),         ENUM(ImGuiColorEditFlags, NoTooltip), ENUM(ImGuiColorEditFlags, NoLabel),
        ENUM(ImGuiColorEditFlags, NoSidePreview),  ENUM(ImGuiColorEditFlags, NoDragDrop),       ENUM(ImGuiColorEditFlags, NoBorder),  ENUM(ImGuiColorEditFlags, AlphaBar),
        ENUM(ImGuiColorEditFlags, AlphaPreview),   ENUM(ImGuiColorEditFlags, AlphaPreviewHalf), ENUM(ImGuiColorEditFlags, HDR),       ENUM(ImGuiColorEditFlags, DisplayRGB),
        ENUM(ImGuiColorEditFlags, DisplayHSV),     ENUM(ImGuiColorEditFlags, DisplayHex),       ENUM(ImGuiColorEditFlags, Uint8),     ENUM(ImGuiColorEditFlags, Float),
        ENUM(ImGuiColorEditFlags, PickerHueBar),   ENUM(ImGuiColorEditFlags, PickerHueWheel),   ENUM(ImGuiColorEditFlags, InputRGB),  ENUM(ImGuiColorEditFlags, InputHSV),
};

static util::TableInteger SliderFlags[] = {
        ENUM(ImGuiSliderFlags, None), ENUM(ImGuiSliderFlags, AlwaysClamp), ENUM(ImGuiSliderFlags, Logarithmic), ENUM(ImGuiSliderFlags, NoRoundToFormat), ENUM(ImGuiSliderFlags, NoInput),
};
...
static util::TableInteger DrawListFlags[] = {
        ENUM(ImDrawListFlags, None),           ENUM(ImDrawListFlags, AntiAliasedLines), ENUM(ImDrawListFlags, AntiAliasedLinesUseTex), ENUM(ImDrawListFlags, AntiAliasedFill),
...
static util::TableInteger DataType[] = {
        ENUM(ImGuiDataType, S8),  ENUM(ImGuiDataType, U8),  ENUM(ImGuiDataType, S16), ENUM(ImGuiDataType, U16),   ENUM(ImGuiDataType, S32),
        ENUM(ImGuiDataType, U32), ENUM(ImGuiDataType, S64), ENUM(ImGuiDataType, U64), ENUM(ImGuiDataType, Float), ENUM(ImGuiDataType, Double),
};

static util::TableInteger Dir[] = {
        ENUM(ImGuiDir, None), ENUM(ImGuiDir, Left), ENUM(ImGuiDir, Right), ENUM(ImGuiDir, Up), ENUM(ImGuiDir, Down),
};
...
static util::TableInteger Mod[] = {
        ENUM(ImGuiMod, None), ENUM(ImGuiMod, Ctrl), ENUM(ImGuiMod, Shift), ENUM(ImGuiMod, Alt), ENUM(ImGuiMod, Super), ENUM(ImGuiMod, Shortcut),
};
...
static util::TableInteger MouseCursor[] = {
        ENUM(ImGuiMouseCursor, None),     ENUM(ImGuiMouseCursor, Arrow),      ENUM(ImGuiMouseCursor, TextInput),  ENUM(ImGuiMouseCursor, ResizeAll), ENUM(ImGuiMouseCursor, ResizeNS),
        ENUM(ImGuiMouseCursor, ResizeEW), ENUM(ImGuiMouseCursor, ResizeNESW), ENUM(ImGuiMouseCursor, ResizeNWSE), ENUM(ImGuiMouseCursor, Hand),      ENUM(ImGuiMouseCursor, NotAllowed),
};
...
static util::TableInteger Cond[] = {
        ENUM(ImGuiCond, None), ENUM(ImGuiCond, Always), ENUM(ImGuiCond, Once), ENUM(ImGuiCond, FirstUseEver), ENUM(ImGuiCond, Appearing),
};
...
#define GEN_FLAGS(name)                  \
    ...
    static util::TableAny flags[] = {
            GEN_FLAGS(WindowFlags),  GEN_FLAGS(ChildFlags),    GEN_FLAGS(InputTextFlags), GEN_FLAGS(TreeNodeFlags), GEN_FLAGS(PopupFlags),    GEN_FLAGS(SelectableFlags),  GEN_FLAGS(ComboFlags),
            GEN_FLAGS(TabBarFlags),  GEN_FLAGS(TabItemFlags),  GEN_FLAGS(FocusedFlags),   GEN_FLAGS(HoveredFlags),  GEN_FLAGS(DockNodeFlags), GEN_FLAGS(DragDropFlags),    GEN_FLAGS(ConfigFlags),
            GEN_FLAGS(BackendFlags), GEN_FLAGS(ButtonFlags),   GEN_FLAGS(ColorEditFlags), GEN_FLAGS(SliderFlags),   GEN_FLAGS(TableFlags),    GEN_FLAGS(TableColumnFlags), GEN_FLAGS(TableRowFlags),
...
#define GEN_ENUM(name)                                            \
    ...
    static util::TableAny enums[] = {
            GEN_ENUM(DataType), GEN_ENUM(Dir),         GEN_ENUM(SortDirection), GEN_ENUM(Key),         GEN_ENUM(Mod),  GEN_ENUM(Col),
            GEN_ENUM(StyleVar), GEN_ENUM(MouseButton), GEN_ENUM(MouseCursor),   GEN_ENUM(MouseSource), GEN_ENUM(Cond), GEN_ENUM(TableBgTarget),
    };
#undef GEN_ENUM
