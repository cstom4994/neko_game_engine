...
return process_def_tree(Namespace("neko_api_core", {
    Doc"neko_api_core namespace. Direct API mappings to C library.",
    ...
    -- -- TODO: offset position and rotation (available in neko_core)
