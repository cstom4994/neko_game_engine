...
inline vec2 vec2_add(vec2 v0, vec2 v1) { return vec2_ctor(v0.x + v1.x, v0.y + v1.y); }

inline vec2 vec2_sub(vec2 v0, vec2 v1) { return vec2_ctor(v0.x - v1.x, v0.y - v1.y); }

inline vec2 vec2_mul(vec2 v0, vec2 v1) { return vec2_ctor(v0.x * v1.x, v0.y * v1.y); }

inline vec2 vec2_div(vec2 v0, vec2 v1) { return vec2_ctor(v0.x / v1.x, v0.y / v1.y); }
...
#define mat3_identity() mat3_diag(1.f)
...
inline vec3 mat3_mul_vec3(mat3 m, vec3 v) { return vec3_ctor(m.m[0] * v.x + m.m[1] * v.y + m.m[2] * v.z, m.m[3] * v.x + m.m[4] * v.y + m.m[5] * v.z, m.m[6] * v.x + m.m[7] * v.y + m.m[8] * v.z); }
