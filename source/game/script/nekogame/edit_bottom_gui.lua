...
ns.edit.status_bar = ng.add {
    transform = { parent = ns.edit.bottom_rect },
    group = { groups = 'builtin' },
    edit = { editable = false },
    gui_rect = { hfill = true },
    gui = {
        color = ng.color(0.8, 0.3, 0.3, 1.0),
        halign = ng.GA_MIN, valign = ng.GA_TABLE,
        padding = ng.vec2_zero,
    }
}
ng.add {
    transform = { parent = ns.edit.status_bar },
    group = { groups = 'builtin' },
    edit = { editable = false },
    gui_text = { str = '' },
    gui = {
...
ng.add {
    transform = { parent = ns.edit.bottom_bar },
    group = { groups = 'builtin' },
    edit = { editable = false },
    gui_text = { str = '' },
    gui = {
...
local function create_status_textbox(gap, label)
    local textbox = ng.add {
        ...
        gui = {
            ...
            halign = ng.GA_TABLE, valign = ng.GA_MAX,
...
ns.edit.command_text_colon = ng.add {
    transform = { parent = ns.edit.command_bar },
    group = { groups = 'builtin' },
    edit = { editable = false },
    gui = {
        color = ng.color_black,
