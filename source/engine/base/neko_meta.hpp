...
namespace std {
template <typename Enum>
struct hash<neko::meta::detail::bitflags<Enum>> {
    size_t operator()(neko::meta::detail::bitflags<Enum> bf) const noexcept { return hash<Enum>{}(bf.as_enum()); }
};
}  // namespace std
...
#define META_HPP_BITFLAGS_OPERATORS_DECL(Enum)                                                                                                                                                        \
    constexpr ::neko::meta::detail::bitflags<Enum> operator~[[maybe_unused]] (Enum l) noexcept { return ~::neko::meta::detail::bitflags<Enum>(l); }                                                   \
    constexpr ::neko::meta::detail::bitflags<Enum> operator| [[maybe_unused]] (Enum l, Enum r) noexcept { return ::neko::meta::detail::bitflags<Enum>(l) | ::neko::meta::detail::bitflags<Enum>(r); } \
    constexpr ::neko::meta::detail::bitflags<Enum> operator& [[maybe_unused]] (Enum l, Enum r) noexcept { return ::neko::meta::detail::bitflags<Enum>(l) & ::neko::meta::detail::bitflags<Enum>(r); } \
    constexpr ::neko::meta::detail::bitflags<Enum> operator^ [[maybe_unused]] (Enum l, Enum r) noexcept { return ::neko::meta::detail::bitflags<Enum>(l) ^ ::neko::meta::detail::bitflags<Enum>(r); }
...
namespace neko::meta {
[[noreturn]] inline void throw_exception(::neko::exception::error_code err) { throw ::neko::exception::exception_meta{err}; }
}  // namespace neko::meta
...
namespace std {
template <>
struct hash<neko::meta::detail::hashed_string> {
    size_t operator()(neko::meta::detail::hashed_string hs) const noexcept { return hs.get_hash(); }
};
}  // namespace std

namespace neko::meta::detail {
template <typename var, typename Allocator>
    requires std::is_move_constructible_v<var> && std::is_move_assignable_v<var>
typename std::vector<var, Allocator>::iterator insert_or_assign(  //
        std::vector<var, Allocator>& vector, typename std::vector<var, Allocator>::value_type&& value) {
...
template <typename var, typename Allocator>
    requires std::is_copy_constructible_v<var> && std::is_copy_assignable_v<var>
typename std::vector<var, Allocator>::iterator insert_or_assign(  //
        std::vector<var, Allocator>& vector, const typename std::vector<var, Allocator>::value_type& value) {
    if (auto&& position{std::find(vector.begin(), vector.end(), value)}; position != vector.end()) {
        *position = value;
        return position;
    }
...
namespace neko::meta::detail {
template <typename Key, typename var, typename Compare, typename Allocator>
void insert_or_assign(  //
        std::map<Key, var, Compare, Allocator>& map, std::map<Key, var, Compare, Allocator>& value) {
    map.swap(value);
    map.merge(value);
}
...
namespace std {
template <typename T>
struct hash<neko::meta::detail::intrusive_ptr<T>> {
    size_t operator()(const neko::meta::detail::intrusive_ptr<T>& ip) const noexcept { return ip.get_hash(); }
};
}  // namespace std
...
namespace std {
template <>
struct hash<neko::meta::detail::memory_buffer> {
    size_t operator()(const neko::meta::detail::memory_buffer& mb) const noexcept { return mb.get_hash(); }
};
}  // namespace std
...
namespace neko::meta {
using ::neko::exception::error_code;
using ::neko::exception::exception_meta;
using ::neko::exception::get_error_code_message;
...
namespace std {
template <>
struct hash<neko::meta::type_id> {
    size_t operator()(const neko::meta::type_id& id) const noexcept { return id.get_hash(); }
};
}  // namespace std
...
namespace std {
template <neko::meta::detail::type_family Type>
struct hash<Type> {
...
namespace std {
template <neko::meta::detail::index_family Index>
struct hash<Index> {
...
namespace std {
template <>
struct hash<neko::meta::uerror> {
    size_t operator()(neko::meta::uerror ue) const noexcept { return ue.get_hash(); }
};
}  // namespace std
...
public:
    ...
    template <typename Instance, typename var>
    void set(Instance&& instance, var&& value) const;

    template <typename Instance, typename var>
    uresult try_set(Instance&& instance, var&& value) const;

    template <typename Instance, typename var>
    void operator()(Instance&& instance, var&& value) const;
    ...
    template <typename Instance, typename var>
    [[nodiscard]] bool is_settable_with(Instance&& instance, var&& value) const noexcept;
    ...
    template <typename Instance, typename var>
    [[nodiscard]] uerror check_settable_error(Instance&& instance, var&& value) const noexcept;
};
...
public:
    ...
    void set(var&& value) const;

    template <typename var>
    uresult try_set(var&& value) const;

    template <typename var>
    void operator()(var&& value) const;

    template <typename var>
    [[nodiscard]] bool is_settable_with() const noexcept;

    template <typename var>
    [[nodiscard]] bool is_settable_with(var&& value) const noexcept;

    template <typename var>
    [[nodiscard]] uerror check_settable_error() const noexcept;

    template <typename var>
    [[nodiscard]] uerror check_settable_error(var&& value) const noexcept;
};
}  // namespace neko::meta

namespace std {
template <neko::meta::detail::state_family State>
struct hash<State> {
...
public:                                                                                                                       \
    ...
    virtual ::neko::meta::detail::poly_info get_most_derived_poly_info(::neko::meta::detail::type_registry& registry) const { \
        using self_type = std::remove_cvref_t<decltype(*this)>;                                                               \
        return ::neko::meta::detail::poly_info{.ptr = this, .type = registry.resolve_class_type<self_type>()};                \
    }                                                                                                                         \
...
namespace neko::meta::detail::class_bind_impl {
...
template <typename Instance, typename var>
void member::set(Instance&& instance, var&& value) const {
    using namespace detail;
    type_registry& registry{type_registry::instance()};
    const uinst vinst{registry, META_HPP_FWD(instance)};
...
template <typename Instance, typename var>
uresult member::try_set(Instance&& instance, var&& value) const {
    using namespace detail;
    type_registry& registry{type_registry::instance()};
...
template <typename Instance, typename var>
void member::operator()(Instance&& instance, var&& value) const {
...
[[nodiscard]] bool member::is_settable_with() const noexcept {
    return !check_settable_error<Instance, var>();
}

template <typename Instance, typename var>
[[nodiscard]] bool member::is_settable_with(Instance&& instance, var&& value) const noexcept {
...
[[nodiscard]] uerror member::check_settable_error() const noexcept {
    ...
    type_registry& registry{type_registry::instance()};
    const uinst_base vinst{registry, type_list<Instance>{}};
    const uarg_base vvalue{registry, type_list<var>{}};
    return state_->setter_error(vinst, vvalue);
}

template <typename Instance, typename var>
[[nodiscard]] uerror member::check_settable_error(Instance&& instance, var&& value) const noexcept {
    using namespace detail;
    type_registry& registry{type_registry::instance()};
    const uinst_base vinst{registry, META_HPP_FWD(instance)};
    const uarg_base vvalue{registry, META_HPP_FWD(value)};
...
template <typename var>
void variable::set(var&& value) const {
    using namespace detail;
    type_registry& registry{type_registry::instance()};
    const uarg vvalue{registry, META_HPP_FWD(value)};
...
template <typename var>
uresult variable::try_set(var&& value) const {
    using namespace detail;
    type_registry& registry{type_registry::instance()};
...
template <typename var>
void variable::operator()(var&& value) const {
    set(META_HPP_FWD(value));
}

template <typename var>
bool variable::is_settable_with() const noexcept {
    return !check_settable_error<var>();
}

template <typename var>
bool variable::is_settable_with(var&& value) const noexcept {
...
template <typename var>
uerror variable::check_settable_error(var&& value) const noexcept {
    using namespace detail;
    type_registry& registry{type_registry::instance()};
    const uarg_base vvalue{registry, META_HPP_FWD(value)};
    return state_->setter_error(vvalue);
