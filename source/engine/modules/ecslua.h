#ifndef NEKO_FLECS_LUA_H
#define NEKO_FLECS_LUA_H
...
struct FlecsLua {
    FlecsLua(flecs::world &world) { FlecsLuaImport(world); }
};
#endif
#endif
...
#define ecs_lua_world(L)       \
    ecs_lua_world_internal(L); \
    lua_Debug ar = {0};        \
...
typedef enum EcsLuaCallbackType { EcsLuaSystem = 0, EcsLuaObserver } EcsLuaCallbackType;
