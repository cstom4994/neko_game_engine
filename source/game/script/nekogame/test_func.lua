...
function test_func:on_create()
    ...
    self.body:make_circle_fixture{
        ...
        radius = 6,
        udata = self.id,
        begin_contact = test_func.begin_contact
    }
    self.body:make_circle_fixture{
        y = -6,
        radius = 6,
...
function test_func:hit(other, damage)
    damage = damage or 1
...
function test_func:co_update(dt)
...
function test_func.begin_contact(a, b)
